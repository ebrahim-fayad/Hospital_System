<footer class="main-footer style-two">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="footer-column col-lg-7 col-md-6 col-sm-12">
                                    <div class="footer-widget logo-widget">
                                        <div class="logo">
                                            <a href="index.html"><img src="{{ asset('Website/images/logo-3.png') }}" alt="" /></a>
                                        </div>
                                    ...
                                    <div class="footer-widget news-widget">
                                        ...
                                        <div class="news-widget-block">
                                            <div class="widget-inner">
                                                <div class="image">
                                                    <img src="{{ asset('Website/images/resource/news-image-1.jpg') }}"alt="" />
                                                </div>
                                        ...
                                        <div class="news-widget-block">
                                            <div class="widget-inner">
                                                <div class="image">
                                                    <img src="{{ asset('Website/images/resource/news-image-2.jpg') }}"alt="" />
                                                </div>
            ...
            <div class="footer-bottom">
                <div class="auto-container">
                    <div class="copyright">MediTech Helth Care &copy; Ibrahim Fayad</div>
                </div>
            </div>
