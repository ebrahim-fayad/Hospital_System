...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{ trans('insurance.all_services') }} </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('insurance.Insurance')}}</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
                ...
                <form action="{{route('Insurances.store')}}" method="post" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            @include('Dashboard.sweet_alert',['error_name'=>'discount_percentage'])
                            @enderror
                        </div>
                        ...
                        <div class="col">
                            ...
                            @error('Company_rate')
                            @include('Dashboard.sweet_alert',['error_name'=>'Company_rate'])
                            @enderror
                        </div>
