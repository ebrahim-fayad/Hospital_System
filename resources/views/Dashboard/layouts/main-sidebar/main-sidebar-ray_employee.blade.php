    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('Rays_Invoices.index') }}"> قائمة الكشوفات</a></li>
                    <li><a class="slide-item" href="{{ route('completedRayInvoices') }}">قائمة الكشوفات المكتملة</a></li>
                </ul>
            </li>
        </ul>
    </div>
