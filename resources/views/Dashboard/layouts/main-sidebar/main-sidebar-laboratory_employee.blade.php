...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
                ...
                <div class="">
                    ...
                    @if (auth()->user()->image)
                        <img src="{{ asset('Dashboard/img/' . auth()->user()->image->fileName) }}"
                            class="avatar avatar-xl brround" alt="">
                    @else
                        <img src="{{ asset('Dashboard/img/doctor_default.png') }}"class="avatar avatar-xl brround"
                            alt="">
                    @endif
                </div>
                <div class="user-info">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('ray_employee.dashboard') }}"><svg
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('Laboratory_Invoices.index') }}"> قائمة الكشوفات</a></li>
                    <li><a class="slide-item" href="{{ route('ray_employee.completedRayInvoices') }}">قائمة الكشوفات المكتملة</a></li>
                </ul>
            </li>
        </ul>
    </div>
