        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('Doctors.index') }}">{{ trans('Doctors.view_all') }}</a>
                    </li>
                </ul>
            </li>
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item"
                            href="{{ route('Services.index') }}">{{ trans('main-sidebar_trans.Single_service') }}</a>
                    </li>
                    <li><a class="slide-item"
                            href="{{ route('Add_GroupServices') }}">{{ trans('main-sidebar_trans.group_services') }}</a>
                    </li>
                    <li><a class="slide-item"
                            href="{{ route('Insurances.index') }}">{{ trans('main-sidebar_trans.Insurance') }}</a>
                    </li>
                    <li><a class="slide-item"
                            href="{{ route('Ambulances.index') }}">{{ trans('main-sidebar_trans.ambulance') }}</a>
                    </li>
                    <li><a class="slide-item"
