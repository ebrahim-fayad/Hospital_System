                                ...
                                <div class="tab-content">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover text-md-nowrap text-center">
                                                ...
                                                <tbody>
                                                    ...
                                                    @include('Dashboard.DoctorAuth.Invoices.edit_xray_conversion')
                                                    @include('Dashboard.DoctorAuth.Invoices.deleted')
                                                    @endforeach
                                                </tbody>
                                            </table>
                                        </div>
                                    ...
                                    <div class="tab-pane" id="tab3">
                                        <div class="table-responsive">
                                            ...
                                            {{-- </th> --}}
                                            {{-- <td colspan="4" --}}
                                            {{-- class="alert alert-primary">{{ number_format( $receipt_accounts->sum('Debit') , 2)}}
                                            </td> --}}
                                            {{-- </tr> --}}
                                            {{-- </tbody> --}}
                                            {{-- </table> --}}
                                    ...
                                    <div class="tab-pane" id="tab4">
                                        ...
                                        {{-- الاجمالي --}}
                                        {{-- </th> --}}
                                        {{-- <td class="alert alert-primary">{{ $Debit= $Patient_accounts->sum('Debit')}}
                                        </td> --}}
                                        {{-- <td class="alert alert-primary">{{ $credit =$Patient_accounts->sum('credit')}}
                                        </td> --}}
