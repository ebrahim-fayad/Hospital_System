...
@section('content')
    ...
    <div class="demo-gallery">
        <ul id="lightgallery" class="list-unstyled row row-sm pr-0">
            ...
            <li class="col-sm-6 col-lg-4" data-responsive="{{asset('Dashboard/img/'.$image->fileName)}}" data-src="{{asset('Dashboard/img/Rays/'.$image->fileName)}}">
                <a href="{{ route('invoices.edit',$image->id) }}">
