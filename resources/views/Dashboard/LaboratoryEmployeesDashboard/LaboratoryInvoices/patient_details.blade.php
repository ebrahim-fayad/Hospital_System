    ...
    <div class="demo-gallery">
        <ul id="lightgallery" class="list-unstyled row row-sm pr-0">
            ...
            @foreach($laboratorie->images as $image)
                ...
                <li class="col-sm-6 col-lg-4" data-responsive="{{asset('Dashboard/img/'.$image->fileName)}}" data-src="{{URL::asset('Dashboard/img/'.$image->filename)}}">
                    <a href="{{ route('Laboratory_Invoices.show', $image->id) }}">
                        <img width="50px" height="350px" class="img-responsive" src="{{asset('Dashboard/img/'.$image->fileName)}}" alt="NoImg">
                    </a>
                </li>
            @endforeach
        </ul>
