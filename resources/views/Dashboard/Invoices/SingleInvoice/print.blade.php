                    ...
                    <div class="card-body">
                        ...
                        <div class="row mg-t-20">
                            ...
                            <div class="col-md">
                                ...
                                <p class="invoice-info-row"><span>اسم الخدمه</span>
                                    <span>{{ $single_invoice->Service->name }}</span>
                                </p>
                                <p class="invoice-info-row"><span>اسم المريض</span>
                                    <span>{{ $single_invoice->patient->name }}</span>
                                </p>
                                <p class="invoice-info-row"><span>تاريخ الفاتوره</span>
                                    <span>{{ $single_invoice->invoice_date }}</span>
                                </p>
                                <p class="invoice-info-row"><span>الدكتور</span>
                                    <span></span>{{ $single_invoice->Doctor->name }}
                                </p>
                                <p class="invoice-info-row"><span>القسم</span>
                                    <span></span>{{ $single_invoice->Section->name }}
                                </p>
                            </div>
                        </div>
                        <div class="table-responsive mg-t-40">
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td class="tx-12">{{ $single_invoice->Service->name }}</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tx-right" colspan="2"> {{ number_format($single_invoice->price, 2) }}
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tx-right" colspan="2">
                                            <h4 class="tx-primary tx-bold">
                                                {{ number_format($single_invoice->total_with_tax, 2) }}</h4>
