                                    ...
                                    <table class="table table-striped mg-b-0 text-md-nowrap" style="text-align: center">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row">1</th>
                                                <td>
                                                    <select wire:model.live="Service_id" class="form-control"
                                                ...
                                                <td><input wire:model.live="price" type="number" min="0" class="form-control"
                                                        readonly></td>
                                                <td><input wire:model.live="discount_value" type="number" min="0"
                                                        class="form-control"
                                                        style="width: 100px"></td>
                                                <th><input wire:model.live="tax_rate" type="number"
                                                        class="form-control"
