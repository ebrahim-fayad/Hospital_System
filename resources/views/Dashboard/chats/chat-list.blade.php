<div class="main-chat-list" wire:ignore='self' id="ChatList">
    @foreach ($conversations as $conversation)
        <div class="media border-bottom-0" wire:click="test({{ $conversation }},{{ (Auth::guard('patient')->check()) ? $this->getDoctorName($conversation,'id'):  $this->getPatientName($conversation,'id') }})">
