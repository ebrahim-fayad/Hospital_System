<div>
    <div class="main-content-body main-content-body-chat">
        <div class="main-chat-header">
            <div class="main-img-user"><img alt="" src="{{  asset('Dashboard/img/faces/9.jpg')}}"></div>
            ...
            <div class="content-inner">
                ...
                <div class="media flex-row-reverse">
                    ...
                    <div class="media-body">
                        ...
                        <div class="main-msg-wrapper pd-0"><img alt="" class="wd-100 ht-100" src="{{  asset('Dashboard/img/ecommerce/01.jpg')}}"></div>
                        <div>
                ...
                <div class="media">
                    <div class="main-img-user online"><img alt="" src="{{  asset('Dashboard/img/faces/6.jpg')}}"></div>
                    <div class="media-body">
