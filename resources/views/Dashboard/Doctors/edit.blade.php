                ...
                <form action="{{ route('Doctors.update', $doctor->id) }}" method="post" autocomplete="off"
                    ...
                    <div class="pd-30 pd-sm-40 bg-gray-200">
                        <div>
                            @if ($doctor->image)
                                <img style="border-radius:20%"
                                    src="{{ asset('Dashboard/img/' . $doctor->image->fileName) }}" height="150px"
                                    width="150px" alt="">
                            @else
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <div class="col-md-11 mg-t-5 mg-md-t-0">
                                <input class="form-control" name="number_of_statements" type="tel"
                                    value="{{ $doctor->number_of_statements }}">
                            </div>
                            @error('number_of_statements')
                                @include('Dashboard.sweet_alert', ['error_name' => 'number_of_statements'])
                            @enderror
                        </div>
...
<script src="{{ URL::asset('Dashboard/plugins/jquery.maskedinput/jquery.maskedinput.js') }}">
    < /> <
    !--Internal spectrum - colorpicker js-- >
        <
        script src = "{{ URL::asset('Dashboard/plugins/spectrum-colorpicker/spectrum.js') }}" >
</script>
