					...
					<div class="col-xl-4 col-md-12 col-lg-6">
						<div class="card">
							<div class="card-header pb-1">
								...
								<p class="tx-12 mb-0 text-muted">Sales activities are the tactics that salespeople used to achieve their goals and objective</p>
							</div>
					...
					<div class="col-xl-4 col-md-12 col-lg-6">
						<div class="card">
							<div class="card-header pb-0">
								...
								<p class="tx-12 mb-0 text-muted">An order is an investors instructions to a broker or brokerage firm to purchase or sell</p>
							</div>
				...
				<div class="row row-sm row-deck">
					...
					<div class="col-md-12 col-lg-8 col-xl-8">
						<div class="card card-table-two">
							...
							<span class="tx-12 tx-muted mb-3 ">This is your most recent earnings for today is date.</span>
