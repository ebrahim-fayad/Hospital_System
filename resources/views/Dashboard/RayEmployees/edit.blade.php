...
<div class="modal fade" id="edit{{ $ray_employee->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('ray_employee.update', $ray_employee->id) }}" enctype="multipart/form-data"
                method="post">
                @method('PUT')
                @csrf
                @csrf
                <div class="modal-body">
                    ...
                    <input type="text" name="name" value="{{ $ray_employee->name }}" class="form-control"><br>
                        </div>
                    </div>
                    ...
                    <div class="row row-sm">
                        <div class="col-sm-6">
                            ...
                            <input type="email" value="{{ $ray_employee->email }}" name="email"
